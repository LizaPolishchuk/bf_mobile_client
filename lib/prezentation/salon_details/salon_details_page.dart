    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          //     child: SvgPicture.asset(salon.isFavourite ? icStarChecked : icStarUnchecked),
          //   ),
          // )
        ],
      ),
    ...
    return InkWell(
      onTap: () {
        if (contentTab == ContentTab.PROMO) {
          _salonDetailsBloc.loadPromos(widget.salon.id, PromoType.temporary_promo);
        } else if (contentTab == ContentTab.BONUSES) {
          _salonDetailsBloc.loadPromos(widget.salon.id, PromoType.bonus_card);
        }
        setState(() {
